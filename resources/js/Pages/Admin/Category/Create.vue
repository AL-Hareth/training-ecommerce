...
// auto-generate slug when name changes, but allow manual edits
        ...
        <header class="mb-6">
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500 mt-1">Add a new category to organize your products.</p>
            </div>
          </div>
        </header>
          ...
          <div class="grid grid-cols-1 gap-6">
            ...
            <div class="flex items-center justify-end gap-3 mt-2">
              <button
                ...
                @click.prevent="form.reset('name','slug','description')"
              >
                Reset
              </button>
              ...
              >
                ...
                <span>{{ form.processing ? 'Saving...' : 'Create Category' }}</span>
              </button>
            </div>
          </div>
        </form>
