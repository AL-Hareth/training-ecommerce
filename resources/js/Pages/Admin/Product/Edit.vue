		...
		<header class="mb-6">
		  <div class="flex items-start gap-4">
			...
			<div>
			  ...
			  <p class="text-sm text-gray-500 mt-1">Update the product details.</p>
			</div>
		  </div>
		</header>
		...
		<form @submit.prevent="submitForm" novalidate>
		  <div class="grid grid-cols-1 gap-6">
			...
			<div>
			  ...
			  <div class="mt-1">
				<textarea id="description" name="description" v-model="form.description" rows="4" class="block w-full rounded-md border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Short description (optional)"></textarea>
			  </div>
